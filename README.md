...
>
> - `feature/part-1-data-exploration`: `docs/data_exploration.md`, `models/staging/_raw_events__eda.md` (doc block для `raw.events`, рендерится в `dbt docs`), `docs/eda_tests.md`, `duckdb-explore.sh`

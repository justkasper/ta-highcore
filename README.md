...
Один проект -> **3**3 связанных DAG'а**, разделённых по SLA и ответственности:
...
- Дополнительно — алерт на отсутствие sentinel'а к ожидаемому времени (≈06:30 UTC): ловит случаи, когда Firebase export опоздал или упал. Это основной сигнал «данные не приехали»; `source freshness` — вторичная проверка на случай, когда sentinel записан, но `loaded_at_field` отстаёт.
### 5.2. Расписание
...
│   └── trailing_avg.sql            # trailing 4w baseline (Block 3, Block 5)
│
